...
class PlaneGame(object):
    ...
    def __init__(self):
        ...
        self.caption_icon = pygame.image.load("images/background/caption_icon.png").convert_alpha()
    ...
    def __start_menu(self):
        ...
        start_bg = pygame.image.load("images/background/start_bg.png").convert_alpha()
        button1 = pygame.image.load("images/button/button1.png").convert_alpha()
        button2 = pygame.image.load("images/button/button2.png").convert_alpha()
        button3 = pygame.image.load("images/button/button3.png").convert_alpha()
        button4 = pygame.image.load("images/button/button4.png").convert_alpha()
        button5 = pygame.image.load("images/button/button5.png").convert_alpha()
        button6 = pygame.image.load("images/button/button6.png").convert_alpha()
        button7 = pygame.image.load("images/button/button7.png").convert_alpha()
        button8 = pygame.image.load("images/button/button8.png").convert_alpha()
        help_txt = pygame.image.load("images/background/help.png").convert_alpha()
        #约定展示按钮的初始形态
    ...
    def select_hero(self):
        start_bg = pygame.image.load("images/background/select_bg.png").convert_alpha()
        plane_1 = pygame.image.load("images/me/m1_1.png").convert_alpha()
        plane_2 = pygame.image.load("images/me/m2_1.png").convert_alpha()
        plane_3 = pygame.image.load("images/me/m3_1.png").convert_alpha()
        plane_4 = pygame.image.load("images/me/m4_1.png").convert_alpha()
        plane_5 = pygame.image.load("images/me/m5_1.png").convert_alpha()
        plane_6 = pygame.image.load("images/me/m6_1.png").convert_alpha()
    ...
    def start_game(self):
        ...
        while running :
            ...
            self.draw_text()
            # 8.绘制护盾
            self.draw_shield_bar(self.screen, width-200, 30, self.show_hero.shield_num)
            # 更新/显示
            pygame.display.update()
    ...
    def __check_collide(self):
        ...
        for hit in hits:
            ...
            bullet_power = hits[hit][0].bullet_power
            if hit.energy < 36:
                hit.real_time_energy = 0
            else:
                hit.real_time_energy -= bullet_power
        ...
        """#敌机与护盾相撞
        hits = pygame.sprite.spritecollide(self.show_hero.shield,self.enemy_group, False)
        for hit in hits:
            score += 150 - hit.enemy_size
            bullet_power = hit.energy
            self.show_hero.shield_num -= hit.enemy_size / 2
            if self.show_hero.shield_num <= 0:
                self.show_hero.shield.kill()
            if hit.energy < 36:
                hit.real_time_energy = 0
            else:
                hit.real_time_energy -= bullet_power
        ...
        #if len(enemies):
            #enemy2_down_sound.play()
            #exp2 = explosion.Explosion(hit.rect.center, 'lg')
            #self.expl_group.add(exp2)
            #time.sleep(3)
            #self.show_hero.kill()
    ...
    def __update_sprites(self):
        ...
        #护盾精灵
        #self.show_hero.shield_group.update()
        self.show_hero.shield.draw(self.screen)
    ...
    def __animate(self):
        ...
        if now - last_update > 50:
            ...
            center = self.show_hero.rect.center
            self.show_hero.mask = self.hero1.mask
            self.show_hero.rect = self.show_hero.image.get_rect()
            self.show_hero.rect.center = center
    ...
    def draw_shield_bar(self,surf , x, y, pct):
        score_font = pygame.font.Font("font/font.ttf", 36)
        score_text = score_font.render("Shield :" , True, WHITE)
        self.screen.blit(score_text, (x-120, y-20))
        if pct < 0:
            pct = 0
        BAR_LENGTH = 100
        BAR_HEIGHT = 10
